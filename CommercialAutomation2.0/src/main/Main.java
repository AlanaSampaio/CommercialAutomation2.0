...
public class Main {
	...
	public static void datasUsers(int operation, ManagementUsers managementSimulator) {
		...
		case 2: //ERRO Cannot invoke "modeling_models.Users.setName(String)" because "userPEdit" is null
			...
			System.out.println("Insita o ID do usuÃ¡rio que deseja alterar: ");
			id = input.next();
		...
		case 3: //ERRO nÃ£o apagou
			...
			System.out.println("Insira o ID do usuÃ¡rio que deseja deletar: ");
			id = input.next();
	...
	public static void menuSimulaFornecedor(int operation, ManagementProviders managementSimulator) {
		...
		case 1:
			...
			cnpj = input.nextLine();
			System.out.println("Insira o endereÃ§o a ser registrado: ");
