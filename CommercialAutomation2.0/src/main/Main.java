...
public class Main {
	...
	/**
	 * Menu inicial do sistema. Leva o usuário para as opções possíveis, ou encerra o sistema.
	 * @param args
	 */
	public static void main(String args[]) {
		...
		while (answer != 2) {
			...
			if (answer == 1) {
				...
				optionsMenu(input); // Menu com as opçpes principais.
	...
	/**
	 * Recebe as informações de login do usuario e certifica
	 * que estejam certas.
